...
Authors: David Fisher and Ryan Fleetham.
...
def main():
    ...
    my_name = "Ryan"  # Used to set the topic that you are *subscribed to*
    # listen to
    team_member_name = "Allison"  # Used to set the topic that you will
    # *publish to*

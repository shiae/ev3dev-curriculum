...
def send_forward(mqtt_client, left_speed_entry, right_speed_entry):
    print("robit_forward")
    l1 = int(left_speed_entry.get())
    print(l1)
    r1 = int(right_speed_entry.get())
    print(r1)
    mqtt_client.send_message("drive", [l1,r1])


def send_backward(mqtt_client):
    print("robit_backward")
    mqtt_client.send_message(("drive"))


def send_left(mqtt_client):
    print("robit_left")
    mqtt_client.send_message(("turn"))

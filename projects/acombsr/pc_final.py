...
def main():
    ...
    left_speed_label = ttk.Label(canvas, text="Left")
    left_speed_label.grid(row=3, column=0)
    left_speed_entry = ttk.Entry(canvas, width=8)
    left_speed_entry.insert(0, "600")
    left_speed_entry.grid(row=4, column=0)

    right_speed_label = ttk.Label(canvas, text="Right")
    right_speed_label.grid(row=3, column=2)
    right_speed_entry = ttk.Entry(canvas, width=8, justify=tkinter.RIGHT)
    right_speed_entry.insert(0, "600")
    right_speed_entry.grid(row=4, column=2)

    forward_button = ttk.Button(canvas, text="Forward")
    ...
    left_button = ttk.Button(canvas, text="Left")
